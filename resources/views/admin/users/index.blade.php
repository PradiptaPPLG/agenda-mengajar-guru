    ...
    <div x-data="{ showImport: false }">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            ...
            <div class="flex gap-3">
                <button type="submit" form="bulk-delete-form" id="btn-bulk-delete" class="hidden px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-xl text-sm font-semibold shadow-sm transition-colors flex items-center gap-2" onclick="return confirm('Yakin ingin menghapus pengguna terpilih?')">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-xs">
            ...
            <table class="w-full text-sm">
                ...
                <tbody id="select-all-banner" class="hidden">
                    <tr>
                        <td colspan="5" class="bg-blue-50/80 text-blue-700 text-sm px-5 py-2.5 text-center border-b border-blue-100">
                            ...
                            <button type="button" id="btn-select-all-pages" class="font-bold underline hover:text-blue-900 ml-1 transition-colors">
                                Pilih seluruh {{ $users->total() }} data
                            </button>
                        </td>
                    </tr>
                </tbody>
                <tbody id="all-selected-banner" class="hidden">
                    <tr>
                        <td colspan="5" class="bg-blue-100 text-blue-800 text-sm px-5 py-2.5 text-center border-b border-blue-200 font-medium">
                            Seluruh <span class="font-bold">{{ $users->total() }}</span> data terpilih.
