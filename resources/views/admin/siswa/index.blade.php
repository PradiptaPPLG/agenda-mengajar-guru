        ...
        <div x-show="showImport" style="display: none;" class="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/60 backdrop-blur-md p-4 transition-all duration-300">
            <div @click.outside="!isSubmitting && (showImport = false)" 
                ...
                <div class="p-6" x-show="!isSubmitting">
                    ...
                    <form action="{{ route('admin.siswa.import') }}" method="POST" enctype="multipart/form-data" @submit="isSubmitting = true">
                        @csrf
                        <div class="mb-6">
                ...
                <div x-show="isSubmitting" style="display: none;" class="p-8 text-center flex flex-col items-center justify-center">
                    ...
                    <h4 class="text-lg font-bold text-slate-900 mb-1.5">Sedang Mengimpor Data Siswa...</h4>
                    <p class="text-xs text-slate-500 max-w-xs leading-relaxed mb-6">
                        Mohon tunggu sebentar, sistem sedang memproses data siswa dan penempatan kelas. <strong class="text-slate-800">Jangan menutup halaman atau klik tombol kembali</strong> agar data tersimpan sempurna.
                    </p>
