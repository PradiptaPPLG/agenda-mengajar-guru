                ...
                <table class="w-full text-left text-sm whitespace-nowrap">
                    ...
                    <tbody class="divide-y divide-slate-200">
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-slate-600">{{ $s->user->email }}</td>
                            <td class="px-6 py-4">
                                @if($s->kelas)
            ...
            <div @click.outside="showImport = false" class="bg-white rounded-2xl w-full max-w-lg shadow-xl overflow-hidden">
                ...
                <div class="p-6">
                    <div class="bg-blue-50 text-blue-700 p-4 rounded-xl text-sm mb-6 space-y-2">
                        <p class="font-semibold">Ketentuan Kolom Excel (.csv):</p>
                    ...
                    <form action="{{ route('admin.siswa.import') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-6">
                            <label class="block text-sm font-medium text-slate-700 mb-2">File CSV <span class="text-red-500">*</span></label>
