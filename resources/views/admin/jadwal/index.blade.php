    ...
    <x-slot:actions>
        <div class="flex items-center gap-2">
            ...
            <a href="{{ route('admin.jadwal.export.pdf', request()->query()) }}"
               class="inline-flex items-center gap-1.5 px-3.5 py-2 bg-rose-600 hover:bg-rose-700 text-white text-sm font-semibold rounded-xl transition-colors shadow-xs">
