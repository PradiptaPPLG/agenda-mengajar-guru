...
complete -c strace -l kill-on-exit -d 'Set  PTRACE_O_EXITKILL ptrace option to all tracee processes (which send a SI…'
...
complete -c strace -l stack-trace-frame-limit -d 'if \'#\'#\' Print no more than this amount of stack trace frames '
