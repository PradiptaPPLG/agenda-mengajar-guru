...
complete -c node -l experimental-addon-modules -d 'Enable experimental addon module support'
complete -c node -l experimental-default-type -d 'Interpret as either ES modules or CommonJS modules input via --eval or STDIN,…'
complete -c node -l experimental-config-file -d 'Specifies the configuration file to load'
complete -c node -l experimental-default-config-file -d 'Enable support for automatically loading node. config. json'
...
complete -c node -l no-experimental-strip-types -d 'Disable experimental type-stripping for TypeScript files'
...
complete -c node -l use-env-proxy -d 'Parse proxy settings from HTTP_PROXY/HTTPS_PROXY/NO_PROXY environment variabl…'
complete -c node -l use-system-ca -d 'Use the trusted CA certificates present in the system store, in addition to t…'
