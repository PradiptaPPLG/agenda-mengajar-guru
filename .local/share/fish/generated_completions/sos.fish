...
complete -c sos -l encrypt-key -d 'Encrypts the resulting archive that sos report produces using GPG'
...
complete -c sos -l threads -d 'Specify the number of threads sos report will use for concurrency'
