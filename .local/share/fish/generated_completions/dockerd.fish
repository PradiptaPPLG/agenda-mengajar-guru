...
complete -c dockerd -s b -l bridge -d '  Attach containers to a pre-existing network bridge, instead of docker0; use…'
complete -c dockerd -l bip -d '  Use the provided CIDR notation IPv4 address for the default bridge network;…'
complete -c dockerd -l bip6 -d '  Use the provided CIDR notation IPv6 address for the default bridge network;…'
complete -c dockerd -l bridge-accept-fwmark -d 'Bridge networks will accept packets with this firewall mark/mask'
...
complete -c dockerd -l default-gateway -d '  IPv4 default gateway for the default bridge network; this address must be p…'
complete -c dockerd -l default-gateway-v6 -d '  IPv6 default gateway for the default bridge network'
complete -c dockerd -l default-address-pool -d '  Default address pool from which IPAM driver selects a subnet for the networ…'
complete -c dockerd -l default-network-opt -d '  Default network driver options'
...
complete -c dockerd -l default-stop-timeout -d '  Set the timeout, in seconds, used to stop containers without a   container-…'
...
complete -c dockerd -l feature -d '  Enable or disable a feature in the daemon'
complete -c dockerd -l firewall-backend -d '  Firewall backend to use, iptables or nftables'
complete -c dockerd -l fixed-cidr -d '  IPv4 subnet for the default bridge network (e. g. , 10. 20. 0'
complete -c dockerd -l fixed-cidr-v6 -d '  IPv6 subnet for the default bridge network (e. g. , 2001:db8::/64)'
...
complete -c dockerd -l host-gateway-ip -d '  Supply host addresses to substitute for the special string host-gateway in …'
complete -c dockerd -l http-proxy -d '  Proxy URL for HTTP requests unless overridden by NoProxy'
complete -c dockerd -l https-proxy -d '  Proxy URL for HTTPS requests unless overridden by NoProxy'
complete -c dockerd -l icc -d '  Allow unrestricted inter-container communication in the default bridge   ne…'
...
complete -c dockerd -l ip -d '  Default host IP address to use when publishing container ports from the   d…'
complete -c dockerd -l ip-forward -d '  Enables IP forwarding on the Docker host.  The default is true'
complete -c dockerd -l ip-forward-no-drop -d '  When false, the default, if Docker enables IP forwarding itself (see   --ip…'
complete -c dockerd -l ip-masq -d '  Enable IP masquerading for default bridge\'s IP range.  Default is true'
complete -c dockerd -l iptables -d '  Enable Docker\'s addition of iptables rules.  Default is true'
complete -c dockerd -l ipv6 -d '  Enable IPv6 support on the default bridge network.  Default is false'
...
complete -c dockerd -l log-format -d '  Set the format for logs produced by the daemon.  Default is "text"'
complete -c dockerd -l log-opt -d '  Logging driver specific options'
complete -c dockerd -l mtu -d '  Set the network MTU for the default bridge network.  Default is 0'
complete -c dockerd -l max-concurrent-downloads -d '  Set the max concurrent downloads.  Default is 3'
complete -c dockerd -l max-concurrent-uploads -d '  Set the max concurrent uploads.  Default is 5'
complete -c dockerd -l max-download-attempts -d '  Set the max download attempts for each pull.  Default is 5'
complete -c dockerd -l no-proxy -d '  Comma-separated values specifying hosts that should be excluded from proxyi…'
...
complete -c dockerd -l allow-direct-routing -d '  Allow remote access to published ports on container IP addresses'
...
complete -c dockerd -l validate -d '  Validate daemon configuration and exit'
