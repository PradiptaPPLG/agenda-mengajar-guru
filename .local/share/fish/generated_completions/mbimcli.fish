...
complete -c mbimcli -l help-intel-mutual-authentication -d 'Show Intel mutual authentication Service options'
complete -c mbimcli -l help-intel-tools -d 'Show Intel 5G tools options'
complete -c mbimcli -l help-google -d 'Show Google Service options'
complete -c mbimcli -l help-fibocom -d 'Show Fibocom Service options'
complete -c mbimcli -l help-sms -d 'Show SMS service options'
complete -c mbimcli -l help-intel-at-tunnel -d 'Show Intel AT Tunnel Service options . SS "Basic Connect options:"'
...
complete -c mbimcli -l ms-device-reset -d 'Reset device'
...
complete -c mbimcli -l ms-query-uicc-terminal-capability -d 'Query UICC terminal capability '
complete -c mbimcli -l intel-query-fcc-lock -d 'Query FCC lock information'
complete -c mbimcli -l intel-set-fcc-lock -d 'Set FCC lock information . PP Intel 5G tools options'
complete -c mbimcli -l intel-set-trace-config -d 'Set trace configuration'
complete -c mbimcli -l intel-query-trace-config -d 'Query trace configuration . SS "Google options:"'
complete -c mbimcli -l google-set-carrier-lock -d 'Set Google Carrier Lock'
complete -c mbimcli -l google-query-carrier-lock -d 'Query Google Carrier Lock . SS "FIbocom options:"'
complete -c mbimcli -l fibocom-set-at-command -d 'send AT command to modem, and receive AT response '
complete -c mbimcli -l sms-delete -d 'Delete all SMS matching a given filter'
complete -c mbimcli -l sms-read -d 'Read all SMS matching a given filter . SS "Intel AT Tunnel options:"'
complete -c mbimcli -l intel-at-tunnel-set-at-command -d 'send AT command to modem, and receive AT response . SS "Application Options:"'
...
complete -c mbimcli -l printable -d 'Get the printable info of the given hex encoded MBIM message'
complete -c mbimcli -s V -l version -d 'Print version COPYRIGHT Copyright © 2013-2023 Aleksander Morgado License GPLv…'
