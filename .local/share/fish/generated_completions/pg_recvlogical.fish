...
complete -c pg_recvlogical -o 't
.br
--two-phase' -d 'Enables decoding of prepared transactions'
...
complete -c pg_recvlogical -l file -d option
complete -c pg_recvlogical -l slot
complete -c pg_recvlogical -l plugin
complete -c pg_recvlogical -l dbname
complete -c pg_recvlogical -l two-phase -d 'can be specified with'
