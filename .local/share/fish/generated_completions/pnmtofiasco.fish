...
complete -c pnmtofiasco -s i -l image-name -d 'Compress the named images, not Standard Input'
...
complete -c pnmtofiasco -s H -l help -d 'Print detailed help, then exit'
