...
complete -c zipinfo -s s -d 'list zipfile info in short Unix ``ls -l\'\' format'
complete -c zipinfo -s m -d 'list zipfile info in medium Unix ``ls -l\'\' format'
complete -c zipinfo -s l -d 'list zipfile info in long Unix ``ls -l\'\' format'
...
complete -c zipinfo -o ICHARSET -d '[UNIX only] Specify a character encoding for UNIX and other archives'
complete -c zipinfo -s I -d '[UNIX only] Specify a character encoding for UNIX and other archives'
complete -c zipinfo -s O -d '[UNIX only] Specify a character encoding for DOS, Windows and OS/2 archives'
