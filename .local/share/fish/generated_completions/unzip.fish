...
complete -c unzip -s I -d '[UNIX only] Specify a character encoding for UNIX and other archives'
...
complete -c unzip -s O -d '[UNIX only] Specify a character encoding for DOS, Windows and OS/2 archives'
